...
class Personality:
    ...
    def __init__(self, 
        ...
        if os.path.exists(system_prompt_file):
            ...
            logger.info(f"Unable to find {system_prompt_file}. Attempting to retrieve from Secret Manager.")
            try:
                ...
                logger.warning(f"Unable to retrieve '{secret_name}' from Secret Manager.")
                raise ValueError(f"{system_prompt_file} not found and could not access '{secret_name}' from Secret Manager: {e}") from e
